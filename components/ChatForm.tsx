...
import { CandyFile } from "./toffee/knowledge/Create";
  ...
  (
    ...
    return (
      <div className="mb-4 px-4 w-full max-w-[650px] absolute bottom-0">
        ...
        <div className={`flex flex-col w-full ${file && !isLoading? "rounded-2xl border-[#B77536] border-[1px]" : "rounded-full"} bg-[#202020]`}>
          ...
          <div className="p-2 flex flex-row w-full items-center">
            <input
              ...
              accept={validImageInputTypes.join(", ") + ", application/pdf"}
              className="hidden"
            />
