  ...
  return (
    <div className="flex flex-col w-full gap-2 ">
      ...
      {result.type === "Tag" && result.tag &&
        <div className="relative h-32 w-full rounded-2xl bg-neutral-800 p-3 pr-16 flex flex-row">
       <div className="min-w-[91px] h-[104px] bg-[#F2CB8D] flex items-center justify-center rounded-2xl">
        <span className="text-black font-semibold text-[32px] ">{result.tag.name.slice(0,1)}</span>
       </div>
        <div className=" flex flex-col pt-1.5 space-y-2 px-4 text-left">
          <div className="text-lg font-normal leading-normal text-white">
            {result.tag.name}
