      ...
      <div className="flex flex-col w-[520px] gap-2 rounded-md bg-bg-3 ">
        <div className="px-10 pt-10 bg-gradient-to-t from-[#BC7F4400] to-[#BC7F4433] rounded-md">
          <Image
            ...
            className="inline"
          />
          <h1 className=" text-white text-xl font-medium leading-7 mt-10">Sign In</h1>
          <span className=" text-[13px] font-light text-text-tertiary mt-2">Welcome to work full of different characters</span>
        </div>
        <div className="px-10 flex flex-col gap-6 pb-10 mt-4">
          <div className="bg-white cursor-pointer rounded-full px-4 py-1.5 w-full flex flex-row justify-center gap-1 items-center" onClick={handleGoogleAuth}>
            ...
            <span className="text-black font-medium text-center  text-sm p-1">Sign in with Google</span>
          </div>
          ...
          <form className="flex flex-col" onSubmit={handleCredentialAuth}>
            <div className="flex flex-col gap-1">
              <label htmlFor="username" className="text-xs  text-text-tertiary">Email</label>
            ...
            <Link href="/forget-password" className="mt-2 text-[#BC7F44]  text-xs font-medium cursor-pointer">Forget password?</Link>
            ...
            <Link href="/signup" className="text-text-tertiary  text-xs cursor-pointer mt-6">{"Don't have an account?  "} <span className="mt-2 text-[#BC7F44]  text-xs font-medium cursor-pointer">Sign Up</span></Link>
          </form>
        </div>
      </div>
    </div>
