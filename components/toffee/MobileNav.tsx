      ...
      <div className="fixed bottom-0 w-full z-50">
        <div className="flex flex-row px-7 pt-3 pb-1 border-t border-white/10 w-full bg-bg-2 justify-between items-end text-white">
          <Link className="flex flex-col items-center" href={"/"}>
            ...
            <span className="text-text-tertiary font-inter text-[11px] mt-0.5">Home</span>
          </Link>
          <Link className="flex flex-col items-center" href={"/"}>
            <RiChat1Line className="w-6 h-6" />
            <span className="text-text-tertiary font-inter text-[11px] mt-0.5">Chat</span>
          </Link>
          ...
          <Link className="flex flex-col items-center" href={"/search"}>
            ...
            <span className="text-text-tertiary font-inter text-[11px] mt-0.5">Search</span>
          </Link>
          <Link className="flex flex-col items-center" href={"/profile"}>
            <RiUserLine className="w-6 h-6" />
            <span className="text-text-tertiary font-inter text-[11px] mt-0.5">Profile</span>
          </Link>
        </div>
