...
const Banner4 = () => {
  return (
    <div className="w-full h-[304px] bg-[#74BD79] rounded-2xl grid sm:grid-cols-2 grid-cols-1 overflow-hidden">
      ...
      <div className="relative w-full hidden sm:block">
        <Image src={"/banners/4.png"} alt="Banner4" width={700} height={304} sizes="100vw" className="absolute right-0 object-cover object-center -mt-4 -mr-[60px]" />
      </div>
    </div>
  )
}
